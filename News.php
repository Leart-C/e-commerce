...
<body>
  ...
  <section id="stylist-outfit">
    ...
    <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni
      recusandae autem id laboriosam error ab!</span>
  </section>
  ...
  <section id="new-arrival">
    <div class="new-one">
      <h4>NEW ARRIVAL</h4>
      <h1>50%off</h1>
      <span>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sed aliquam
        illo nostrum eaque, debitis Vero, voluptatum veniam.</span>
  ...
  <section id="best-choices">
    ...
    <div class="product-holder">
      ...
      <div class="prod2">
        <img src="img/newArrivalTwo.jpg" alt="" />
        <button>Shop Now</button>
      </div>
      <div class="prod3">
        <img src="img/newArrivalThree.jpg" alt="" />
        <button>Shop Now</button>
      </div>
    </div>
  </section>

  <section id="weeklyDeals">
    <div class="weeklyDealsOne">
      <h1>WEEKLY</h1>
      <h1>DEALS</h1>
      <span>
